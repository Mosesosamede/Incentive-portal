...
export default function OnboardingWizard({
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-100 flex flex-col justify-between relative overflow-hidden" id="onboarding-root">
      {/* Utilities Rail */}
      <div className="w-full bg-[#080d1a] border-b border-slate-900/60 py-2.5 px-6 flex justify-between items-center text-[11px] font-mono text-slate-500" id="onboarding-rail">
      ...
      <main className="max-w-2xl w-full mx-auto px-6 py-12 z-10 flex-grow flex flex-col justify-center font-sans" id="onboarding-main">
        {existingAccountError ? (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-[#080d1a] border border-red-500/30 rounded-2xl p-8 text-center max-w-md mx-auto shadow-2xl" id="blocked-screen">
          ...
          <>
            ...
            {/* Wizard Card */}
            <div className="p-8 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-xl shadow-2xl relative" id="wizard-card">
                ...
                {onboardingStep === 1 && (() => {
                  ...
                  return (
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-4" id="step-1-view">
                      ...
                      {/* Country Selector */}
                      <div className="flex flex-col gap-1.5 mb-2 bg-[#050914] border border-slate-800 p-4 rounded-xl" id="country-select-wrapper">
                ...
                <div className="flex justify-between items-center mt-6 pt-4 border-t border-slate-800/80">
                  {onboardingStep > 1 ? (
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-xs font-semibold text-slate-300 hover:text-white transition cursor-pointer font-sans"
                    >
                      Back
                    </button>
                  ) : (
                  ...
                  {onboardingStep < 4 ? (
                    <button
                      ...
                      className="px-5 py-2.5 rounded-xl bg-amber-500 text-slate-950 text-xs font-bold hover:bg-amber-600 transition flex items-center gap-1.5 cursor-pointer font-sans"
                    >
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 rounded-xl bg-emerald-500 text-slate-950 text-xs font-bold hover:bg-emerald-600 transition flex items-center gap-1.5 cursor-pointer font-sans disabled:opacity-50"
                    >
